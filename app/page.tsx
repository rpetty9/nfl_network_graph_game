      ...
      <div className="relative mx-auto max-w-[1380px]">
        ...
        {submitted ? (
          ...
          <div className="relative mt-4 mx-auto h-[500px] max-w-[1080px] overflow-hidden rounded-[36px] border-[4px] border-sky-200 bg-[radial-gradient(circle_at_top,#ffffff_0%,#f0f9ff_46%,#f8f4ea_100%)] p-3 shadow-[0_20px_0_rgba(125,211,252,0.12),0_24px_60px_rgba(125,211,252,0.18)] backdrop-blur-sm sm:h-[700px] md:h-[760px] md:max-w-[1080px] md:p-4">
              <div className="absolute inset-x-3 top-3 z-40 grid grid-cols-3 gap-2 sm:inset-x-4 sm:top-4 sm:gap-3">
                <div className="inline-flex min-w-0 items-center justify-center gap-2 rounded-full border-[3px] border-sky-200 bg-white/90 px-2.5 py-2 shadow-[0_8px_20px_rgba(125,211,252,0.16)] sm:justify-start sm:px-4">
                  ...
                  <select
                    ...
                    className="min-w-0 bg-transparent text-center text-[8px] font-black uppercase tracking-[0.06em] text-sky-700 outline-none sm:text-left sm:text-[10px] sm:tracking-[0.08em]"
                ...
                <div className="inline-flex min-w-0 items-center justify-center gap-1.5 rounded-full border-[3px] border-sky-300 bg-[linear-gradient(180deg,#ffffff_0%,#ecfeff_100%)] px-2 py-2 text-center shadow-[0_10px_24px_rgba(56,189,248,0.18)] sm:gap-2 sm:px-5 sm:py-2.5">
                  ...
                  <span className="min-w-0 text-[8px] font-black uppercase tracking-[0.04em] text-sky-800 sm:text-[11px] sm:tracking-[0.07em]">
                    {puzzleData.theme?.display_name ?? "Daily Time Period"}
                  </span>
                </div>

                <div className="inline-flex min-w-0 items-center justify-center gap-1.5 rounded-full border-[3px] border-slate-200 bg-white/92 px-2 py-2 text-center shadow-[0_8px_20px_rgba(148,163,184,0.12)] sm:gap-2 sm:px-4 sm:py-2.5">
